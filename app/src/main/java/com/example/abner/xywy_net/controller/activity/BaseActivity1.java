...
import com.example.abner.xywy_net.utils.netutils.SelectPicPopupWindow;
...
public class BaseActivity1 extends FragmentActivity {
	...
	public void showPicturePopupWindow(){
		...
		menuWindow.showAtLocation(findViewById(R.id.freeask_LinearLayout), Gravity.BOTTOM| Gravity.CENTER_HORIZONTAL, 0, 0);
	}
